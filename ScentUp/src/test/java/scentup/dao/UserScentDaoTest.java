...
public class UserScentDaoTest {
    ...
    @Test
    public void isActiveUserScentListingCorrect() throws ClassNotFoundException, SQLException {
        String randomuser = UUID.randomUUID().toString().substring(0, 6);
        String randomname = UUID.randomUUID().toString().substring(0, 6);
        ...
        assertEquals(2, userScents.findAllForUser(1, testuser.getUserId()).size());
